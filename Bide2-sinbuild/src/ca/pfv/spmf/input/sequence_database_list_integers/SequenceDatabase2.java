...
public class SequenceDatabase2 {
	...
	public void loadFile(String path) throws IOException {
		...
		try {
			...
			//int i=0;   ESTO NO SE USA! 
//			while ((thisLine = myInput.readLine()) != null) {
//				// if the line is not a comment, is not empty or is not other
//				// kind of metadata
//				if (thisLine.isEmpty() == false && thisLine.charAt(0) != '#' 
//						&& thisLine.charAt(0) != '%' && thisLine.charAt(0) != '@') {
//					if(thisLine.charAt(0) == '-') {		//si es un - quiere decir que es el nombre de la clase! --- yop
//						addClases(thisLine.split(" "));
//					}					
//					else { 		//si NO es un - quiere decir que es la secuencia! --- yop
