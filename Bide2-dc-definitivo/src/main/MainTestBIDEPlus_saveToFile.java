...
public class MainTestBIDEPlus_saveToFile {
	...
	public static void main(String [] arg) throws IOException{ 
		...
		//sequenceDatabase2.loadFile(fileToPath("ejemplo-clases.txt"));
		sequenceDatabase2.loadFile(fileToPath("ejemplo-3clases.txt"));
		//sequenceDatabase2.loadFile(fileToPath("ejemplo2.txt"));
        ...
        algo2.setShowSequenceIdentifiers(false);	//YOP esto es lo que falla aún!
		
		// execute the algorithm
        algo2.runAlgorithm(sequenceDatabase2, ".//output.txt", minsup2,k);  
