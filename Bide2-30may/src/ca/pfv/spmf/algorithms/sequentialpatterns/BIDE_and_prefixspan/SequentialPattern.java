...
//	private int id; 
	...
	public String getRelativeSupportFormated(int sequencecount) {
		double relSupport = ((double)getSupport()) / ((double) sequencecount);	//yop el getSupport antes era un sequenceIds.size()
		// pretty formating :
	...
	public int getAbsoluteSupport(){
		System.out.println("SEQUENTIALPATTERN---El getAbsoluteSupport de este mapa-this.seuencesIds es: " + sequencesIds.values().size());
		return sequencesIds.values().size();
	}
...
//		}
	...
	/**Yop
	 * Devuelve el tamanio/suporte de sequencesIds
	 * @return int entero con valor del soporte
	 */
	public int getSupport() {	//YOP no veo la diferencia entre soporte y soporte absoluto, así que están iguales
		System.out.println("SEQUENTIALPATTERN---El getSupport de este mapa-this.seuencesIds es: " + sequencesIds.values().size());
		return sequencesIds.values().size();
	}
}